...
public class ProgressBarTreeTableCell<S> extends TreeTableCell<S, Double> {
	 ...
	 *
	 * @param <S>
	 *            The type of the TreeTableView generic type
	...
	public void updateItem(Double item, boolean empty) {
		...
		if (empty) {
			...
			if (observable != null) {
				...
				PropertyAdapter<String, Double> percent = new PropertyAdapter<String, Double>((Property<Double>) observable, converter);
